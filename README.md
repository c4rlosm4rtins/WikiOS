# WikiOS - Operating Systems Knowledge Base

A small interactive encyclopedia about Operating Systems — created as a project for Alura's "Imersão Dev 10". This site is lightweight, attractive, and responsive: perfect for learning, quick reference.
